...
jQuery.fn.extend({
    ...
    invalidChar: function (invalid_chars)
    {
        ...
        if (typeof invalid_chars != "object")
        {
        ...
        return this.each(function ()
        {
            $(this).parent().append('<span class="' + feature + '-error-message error-message hidden">&#9679 Invalid Character</span>');
            var error_span = $(this).parent().find(".feature" + '-error-message');
            ...
            $(this).on(events.validate, function ()
            {
                ...
                {
                    var invalid_char = invalid_chars[i];
    ...
    srLoader: function ()
    {
        ...
        return this.each(function ()
        {
            ...
            if ($(this).applyOnce(feature))
            {
                ...
                {
                    $(this).children("." + cls).addClass("hidden");
