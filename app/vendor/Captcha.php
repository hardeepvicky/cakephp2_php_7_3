...
class Captcha
{
    public function text($text, $textColor, $backgroundColor = '', $fontSize, $imgWidth, $imgHeight, $dir, $fileName)
    {
        /* settings */
        $font = './frontend/fonts/calibri.ttf'; /* define font */
    ...
    public function getImage($textColor, $backgroundColor, $imgWidth, $imgHeight, $noiceLines = 0, $noiceDots = 0, $noiceColor = '#162453')
    {
        $text = $this->random();
        $font = './frontend/fonts/monofont.ttf'; /* font */
        $textColor = $this->hexToRGB($textColor);
