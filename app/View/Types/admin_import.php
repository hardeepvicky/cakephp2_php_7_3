<?php
$title_for_layout = isset($title_for_layout) ? $title_for_layout : "Order Import";
?>
    ...
    ?>
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <a href="<?= $sample ?>" target="_blank">Download Sample</a>
                </div>
            </div>
        </div>
        <div class="action-buttons">
            <div class="col-md-offset-4 col-md-8 col-sm-offset-4 col-sm-8 col-xs-12">
                ...
                <a class="btn grey" href="<?= $this->Html->url(array("action" => "admin_import")) ?>">Cancel</a>
            </div>
        </div>
