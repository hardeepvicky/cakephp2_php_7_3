<?php
$title_for_layout = "Notification Log";
?>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Sub Type :</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?= $this->Form->input('sub_type', array(
                                    'type' => 'select', 
                                    "class" => "form-control select2me",
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Title / Details :</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
