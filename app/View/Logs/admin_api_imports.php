...
<div class="row">
    <div class="col-md-6">
        <h3> Api Import Log </h3>
    </div>
    <div class="col-md-6 text-right" style="margin-top: 6px;">
        <a class="btn btn-default" href="<?= $this->Html->url(array("action" => "api_imports", "admin" => true)) ?>">Summary Log</a>
        <a class="btn blue" href="<?= $this->Html->url(array("action" => "api_import_tree", "admin" => true)) ?>">Tree Log</a>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Api :</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
