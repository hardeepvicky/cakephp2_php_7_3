                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Controller :</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?= $this->Form->input('_controller', array(
                                    'value' => ${$model . "_controller"},
                                )); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Only Heavy Query :</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?= $this->Form->input('have_heavy_query', array(
                                    'type' => 'select',
                                    'class' => 'form-control select2me',
                                    'options' => StaticArray::YES_NO,
                                    'empty' => DROPDOWN_EMPTY_VALUE,
                                    'value' => ${$model . "have_heavy_query"},
                                )); ?>
                            </div>
                        </div>
                    </div>
