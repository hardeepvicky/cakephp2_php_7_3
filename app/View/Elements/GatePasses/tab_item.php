...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        $("#location_box_item").on("click", "a.delete_location", function (e)
        {
            e.preventDefault();
            var _this = $(this);
        ...
        $("#location_box_item").on("click", "a.delete_box, a.delete_item", function (e)
        {
            e.preventDefault();
            var _this = $(this);
            var href = $(this).attr("href");
        ...
        $("#location_box_item").on("click", ".add_box", function (e)
        {
            var gpl_id = $(this).attr("data-gpl_id");
            var url = "/<?= $controller ?>/ajaxBoxSave/gate_pass_id:" + gate_pass_id + "/gate_pass_location_id:" + gpl_id;
        ...
        $("#location_box_item").on("click", "a.edit_box", function (e)
        {
            var id = $(this).attr("data-id");
            var gpl_id = $(this).attr("data-gpl_id");
            var url = "/<?= $controller ?>/ajaxBoxSave/" + id + "/gate_pass_id:" + gate_pass_id + "/gate_pass_location_id:" + gpl_id;
        ...
        $("#location_box_item").on("click", ".add_item", function (e)
        {
        ...
        $("#location_box_item").on("click", "a.edit_item", function (e)
        {
            var id = $(this).attr("data-id");
            var gpl_id = $(this).attr("data-gpl_id");
            var box_id = $(this).attr("data-box_id");
        ...
        function get_location_box(gpl_id)
        {
            ...
            {
                $("#location_box_item").load("/<?= $controller ?>/ajaxGetLocationBoxItem/" + gate_pass_id);
            }
            else
            {
                $.get("/<?= $controller ?>/ajaxGetLocationBoxItem/" + gate_pass_id + "/" + gpl_id, function(response)
                {
                    ...
                    {
                        $("#location_box_item").append(response);
                    }
                });
            }
        }
