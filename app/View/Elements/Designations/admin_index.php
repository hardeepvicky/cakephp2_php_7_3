        ...
        <table class="table table-striped table-bordered order-column" id="sample_1_2">
            <thead>
                <tr>
                    ...
                    <th> Department </th>
                    <th> <?= $this->Paginator->sort('ParentDesignation.name', __('Parent Designation')); ?> </th>
                    <th> <?= $this->Paginator->sort('name', __('Designation')); ?> </th>
            ...
            <tbody>
                ...
                <tr class="odd gradeX center">
                    ...
                    <td><?= $record["ParentDesignation"]['name']; ?></td>
