        ...
        <table class="table table-striped table-bordered order-column" id="sample_1_2">
            ...
            <tbody>
                ...
                <tr class="odd gradeX center">
                    ...
                    <td><?= $types[$record[$model]['type']]; ?></td>
                    <td><?= isset($item_list[$record[$model]['item_id']]) ? $item_list[$record[$model]['item_id']] : "-"; ?></td>
                    <td><?= isset($sku_list[$record[$model]['product_id']]) ? $item_list[$sku_list[$model]['product_id']] : "-"; ?></td>
                    <td>
