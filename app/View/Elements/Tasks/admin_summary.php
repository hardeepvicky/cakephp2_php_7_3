        ...
        <table class="table table-striped table-bordered order-column" id="sample_1_2">
            <thead>
                <tr>
                    ...
                    <th> Assignee </th>
                    <th> Title </th>
                    <th style="width : 12%;"> <?= $this->Paginator->sort('start_date', __('Start Date')); ?> </th>
                    <th style="width : 12%;"> <?= $this->Paginator->sort('end_date', __('End Date')); ?> </th>
                    <th style="width : 12%;"> Left Time </th>
                    <th style="width : 10%;"> <?= $this->Paginator->sort('priority', __('Priority')); ?> </th>
            ...
            <tbody>
                ...
                <tr class="odd gradeX center">
                    ...
                    <td><?= $user_list[$record[$model]['assigner_user_id']]; ?></td>
                    ...
                    <td>
                        <?php
                        if (!$record[$model]['is_completed'] && !$record[$model]['is_expired'])
                        {
                            $diff = DateUtility::diff($record[$model]['end_date'], date(DateUtility::DATETIME_FORMAT));
                            echo Util::niceTime($diff); 
                        }
                        ?>
                    </td>
