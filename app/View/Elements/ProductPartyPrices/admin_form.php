...
<div class="form__structure">
    ...
    ?>
        <div class="form-body">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-4 col-xs-12">Party <span>*</span> :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $this->Form->input('party_id', array(
                        "type" => "select",
                        "options" => $party_list,
            ...
            <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: 7px;">
