<div class="form-body">
    <?= $this->element("$controller/scanable_form", array("sub_location_will_appear" => false)) ?>
    ...
    <div class="portlet box blue-hoki" style="margin-top : 5px;">
        ...
        <div class="portlet-body">
            <div class="form-group" style="max-height : 300px; overflow-y: scroll;">
                <?= $this->element("$controller/scanable_scan_table") ?>
            </div>
        </div>
    </div>
    <?php 
    ...
    {
        echo $this->element("$controller/scanable_inventory_detail_table_purchase_order");
    } 
    else
    {
        echo $this->element("$controller/scanable_inventory_detail_table");
    }
    ?>
...
<?php if (isset($open_sub_location_id)): ?>
    var open_sub_location_id = '<?= $open_sub_location_id ?>';
<?php endif; ?>
...
{        
    ...
    $(document).on("keydown", "input#scan-code", function(e) 
    {
        ...
        if( code == 13)// Enter key hit
        {
            ...
            if (typeof open_sub_location_id != "undefined")
            {
                data["sub_location_id"] = open_sub_location_id;
            }
