<div class="form-body">
    ...
    <div class="portlet box blue-hoki" style="margin-top : 5px;">
        ...
        <div class="portlet-body">
            <div class="form-group" style="max-height : 300px; overflow-y: scroll;">
                <?= $this->element("$controller/scanable_scan_table", array("sub_location_will_appear" => true)) ?>
            </div>
        </div>
    </div>
    ...
    <?= $this->element("$controller/scanable_inventory_detail_stock_transfer_table", array("sub_location_will_appear" => true)) ?>
</div>  

<?php if ($this->request->data[$model]["created_by"] == $auth_user["id"] && !$this->request->data[$model]['is_reffer']): ?>
