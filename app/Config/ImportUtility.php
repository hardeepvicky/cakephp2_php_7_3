...
class ImportUtility
{
    ...
    public function __construct($sample_file, $post_csv_file, $max_count = 50000) 
    {
        ...
        $this->sample_data = CsvUtility::fetchCSV($this->sample_csv_file, FALSE);
        $this->post_data = CsvUtility::fetchCSV($this->post_csv_file); 
    ...
    public function checkHeaders()
    {
        ...
        {
            $col = trim($col);
            $col_2 = Util::StringOpearion($col, array("trim", "strtolower", "replace_multple_space_with_single_space", "replace_space_with_hyphine"));
